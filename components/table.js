...
function Table()
{
    ...
    return (
        <>
            ...
            <div id="storeTable">
                <table class="rounded-lg border-2 border-opacity-100 border-green-400">
                    <tr>
                    <th>Location</th>
...

                    {
                        ...
                        {
                            sales[idx].map( sales =>
                                <td class="rounded-lg border-2 border-opacity-100 border-green-400"></td>
                            )
                        }
                    ...
                    <tr>
                        <th class="rounded-lg border-2 border-opacity-100 border-green-400">Totals</th>
                        {
                            props.hours.map((time, idx) => {
                                ...
                                return <td class="rounded-lg border-opacity-100 border-green-400">{hourTotal}</td> 
                            })
                        }
